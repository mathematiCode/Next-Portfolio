...
export const blogPostsConfig: BlogPostConfig[] = [
  ...
  },
  {
    ...
    preview: (
      <div className="relative w-full h-2/3 py-16 px-6 rounded-md text-2xl  bg-primary text-light-accent shadow-2xl ring-2 ring-orange-300">
        Do you want to save this as your default location?
        <div className="absolute flex right-4 bottom-4 gap-4">
          <span className="bg-light-accent text-primary px-3 rounded">Yes</span>
          <span className="bg-light-accent text-primary px-3 rounded">No</span>
        </div>
      </div>
    ),
    published: false,
