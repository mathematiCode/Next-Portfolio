...
In addition to improving my Git workflow, I want to deepen my understanding of design patterns, GitHub Actions, accessibility, and React itself. I also want to finish the half-started blog posts I’ve accumulated and continue writing when I encounter interesting problems. I believe documenting these challenges will be helpful both for my future self and for others who may run into similar issues down the line.
