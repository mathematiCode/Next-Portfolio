...
For my first big project, <span className="underline">[Visual Fraction Library](https://visualfractionlibrary.com)</span>, I was creating models of fraction division with up to 300 circles for users to download as images.
