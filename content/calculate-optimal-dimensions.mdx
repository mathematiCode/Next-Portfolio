...
<div className="flex flex-col md:flex-row justify-between items-center gap-4">
  <div className="w-[300px] h-[100px] relative justify-self-center">
    <div className="w-full h-[100px] border-2" />
    <span className="absolute top-[107px] left-[120px]">900px</span>
    <span className="absolute top-[45px] right-[-50px]">300px</span>
  </div>
  <ArrowBigRight size={45} strokeWidth={1.25} className="hidden md:block" />
  <ArrowBigDown size={45} strokeWidth={1.25} className="block mt-8 md:hidden" />
  <div className="w-[300px] h-[300px] relative justify-self-center">
    <div className="w-full h-[100px] border-2" />
    <div className="w-full h-[100px] border-2" />
    <div className="w-full h-[100px] border-2" />
    <span className="absolute top-[75px] left-[120px]">900px</span>
    <span className="absolute top-[150px] right-[-50px]">900px</span>
  </div>
</div>
<br />
