...
In April, I started an apprenticeship at Gridiron Survivor, where I worked with a team on a [**Secret Santa app**](https://www.secretsanta-exchange.com/). I learned a ton about writing **unit, integration, and end-to-end tests**, using ESLint and Prettier, and writing clear, thoughtful PR descriptions.
...
Around this time, I also appeared on my first podcast, [**John Crickett’s Coding Chats**](https://youtu.be/t_USNGEKfHc?si=toH-SQUMzczO6yIT), where I talked about the game. That experience made the project feel more real and public, and I started to believe that finishing it and getting real users could directly lead to getting a job.
...
Around the same time, I received an offer for a paid internship at a small startup called [**Meet Near Me**](https://meetnear.me/). This role pushed me further than any project I had worked on before. I learned **Golang, Alpine.js, Templ, and HTMX**, and had to adapt to a much more complex build system than I was used to.
