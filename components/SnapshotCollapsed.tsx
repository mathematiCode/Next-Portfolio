...
function SnapshotCollapsed({ snapshot }: { snapshot: SnapshotType }) {
  ...
  if (!isExpanded && currentProject.id === '') {
    return (
      <div
        className="flex items-center justify-between py-4 px-6 w-full rounded-lg bg-secondary border-2 border-black relative mx-auto my-5 cursor-pointer hover:shadow-md-primary transition-all"
  ...
  return (
    <div
      className={`flex flex-col gap-3 py-10 px-10 w-full rounded-lg bg-secondary border-2 border-black relative mx-auto my-5 overflow-auto shadow-md-primary ${
